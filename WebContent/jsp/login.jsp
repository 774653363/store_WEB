...
<form class="form-horizontal" action="${pageContext.request.contextPath }/UserServlet" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="username" placeholder="请输入用户名" name="username" value="${cookie.remenberUsernameCookie.value }" }>
    </div>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        ...
        <label>
          <input type="checkbox" name="remenberUsername" ${not empty cookie.remenberUsernameCookie?"checked='checked'":"" }> 记住用户名
        </label>
      </div>
    </div>
  </div>
